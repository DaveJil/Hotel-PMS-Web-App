...
contextBridge.exposeInMainWorld('api', {
  ...
  openBackdatedPortal: () => invoke('app:openBackdatedPortal'),
  portalLogin: (username, password) => invoke('portal:login', username, password),
  portalLogout: () => invoke('portal:logout'),
  getPortalBootstrap: () => invoke('portal:getBootstrap'),
  lookupReservationForPortal: (resId) => invoke('portal:lookupReservation', resId),
  saveBackdatedEntry: (payload) => invoke('portal:saveEntry', payload),
  getBackdatedEntries: () => invoke('portal:getEntries'),
